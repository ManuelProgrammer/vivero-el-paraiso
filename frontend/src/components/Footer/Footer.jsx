  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.contenido}>
        ...
        <div className={styles.columna}>
          <img
            ...
            alt="Vivero El Paraíso"
            className={styles.logo}
          />
          <p className={styles.descripcion}>
            Tu vivero favorito. Plantas, árboles, flores y todo lo que
            necesitas para tu jardín, directo a tu puerta.
          </p>
        ...
        <div className={styles.columna}>
          <h4 className={styles.titulo}>Categorías</h4>
          <ul className={styles.lista}>
            <li><Link to="/tienda?categoria=plantas">🌱 Plantas</Link></li>
            <li><Link to="/tienda?categoria=arboles">🌳 Árboles</Link></li>
            <li><Link to="/tienda?categoria=flores">🌸 Flores</Link></li>
            <li><Link to="/tienda?categoria=herramientas">🛠️ Herramientas</Link></li>
            <li><Link to="/tienda?categoria=abonos">🌿 Abonos</Link></li>
            <li><Link to="/tienda?categoria=fertilizantes">💧 Fertilizantes</Link></li>
          </ul>
        </div>

        {/* Columna 4 — Contacto */}
        <div className={styles.columna}>
          <h4 className={styles.titulo}>Contáctenos</h4>
          <ul className={styles.listaContacto}>
            ...
            <li>
              <span>📞</span>
              <span>Tel: 314 596 4947</span>
            </li>
            <li>
              <span>📱</span>
              <span>Cel: 300 312 3507</span>
            </li>
            <li>
              <span>✉️</span>
              <span>fontalvcoronado9@gmail.com</span>
            </li>
            <li>
              <span>🕐</span>
      ...
      <div className={styles.barraInferior}>
        <p>© 2026 Vivero El Paraíso — Todos los derechos reservados</p>
        <p>Desarrollado con 🌿 por Manuel Programmer</p>
      </div>
